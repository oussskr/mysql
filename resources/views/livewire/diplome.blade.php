            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                 ...
                 <div class="flex gap-4 my-2">
                    ...
                    <x-mary-button label="Afficher" class="btn-success"  wire:click="reload" />
                     <x-mary-button  label="Ajouter"  @click="$wire.showFormulairedip = true" class="btn-primary" spinner="save2" />
...
@endif
<x-mary-modal wire:model="showFormulairedip" persistent class="backdrop-blur">
        <livewire:formulairedip>
